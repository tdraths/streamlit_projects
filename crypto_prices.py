...
def load_data():
    ...
    df = pd.DataFrame(columns=['coin_name', 'coin_symbol', 'market_cap','percent_change_24h', 'percent_change_7d', 'price', 'volume_24h'])
...
df_change = pd.concat([df_coins.coin_symbol, df_coins.percent_change_24h, df_coins.percent_change_7d], axis=1)
